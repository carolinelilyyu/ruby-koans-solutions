...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Starting with the injected arguement to be sum, you would do that operation
    # against that sum with each element
  end
  ...
  # Guess : we do this because there might be more than one file with that name
  # Guess 2: don't have to write a closing and opening line everytime. we just call the yield 
  #and the arguments passed into a block and ensure it closes every time we open it.
end
