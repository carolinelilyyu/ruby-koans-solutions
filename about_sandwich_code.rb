...
class AboutSandwichCode < Neo::Koan
  ...
  def find_line2(file_name)
    #do | | is a way of defining arguments for blocks
    #http://web.archive.org/web/20160922220431/http://www.reactive.io/tips/2008/12/21/understanding-ruby-blocks-procs-and-lambdas
    file_sandwich(file_name) do |file|
      while line = file.gets
        return line if line.match(/e/)
      end
