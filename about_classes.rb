...
class AboutClasses < Neo::Koan
  ...
  def test_args_to_new_must_match_initialize
    ...
    #Because number of arguments must match. Attr_reader needs a name, but initialize
  ...
  def test_to_s_is_used_in_string_interpolation
    fido = Dog7.new("Fido")
    #because #{} is a string interpolation, it will automatically switch it to Fido
