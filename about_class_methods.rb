...
class AboutClassMethods < Neo::Koan
  ...
  # for other readers, << is harder to understand for a beginner. it's not as explicit as first kind
  #for python that's also how you define classes. it's more truncated and there's only one end to take care of

  #maybe a time when you'd want to do << self is when you have a lot of methods so it isn't as verbose
  #in that case, i'd still personally prefer to do .self
  # ------------------------------------------------------------------
